...
namespace SoulShop.DAL
{
	...
	public partial class V_ShopProduct_Product
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(SoulShop.Model.V_ShopProduct_Product model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into V_ShopProduct_Product(");
			strSql.Append("ID,Size,Color,Stock,Pirce,MonthlySale,ShopID,ProductID,Name,Description,AreaID,ProductCategoryID)");
			...
			parameters[4].Value = model.Pirce;
			parameters[5].Value = model.MonthlySale;
			...
			parameters[11].Value = model.ProductCategoryID;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SoulShop.Model.V_ShopProduct_Product model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update V_ShopProduct_Product set ");
			strSql.Append("ID=@ID,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from V_ShopProduct_Product ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SoulShop.Model.V_ShopProduct_Product GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Size,Color,Stock,Pirce,MonthlySale,ShopID,ProductID,Name,Description,AreaID,ProductCategoryID from V_ShopProduct_Product ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			SoulShop.Model.V_ShopProduct_Product model=new SoulShop.Model.V_ShopProduct_Product();
		...
		/// 得到一个对象实体
		/// </summary>
		public SoulShop.Model.V_ShopProduct_Product DataRowToModel(DataRow row)
		{
			SoulShop.Model.V_ShopProduct_Product model=new SoulShop.Model.V_ShopProduct_Product();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Size,Color,Stock,Pirce,MonthlySale,ShopID,ProductID,Name,Description,AreaID,ProductCategoryID ");
			strSql.Append(" FROM V_ShopProduct_Product ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "V_ShopProduct_Product";
