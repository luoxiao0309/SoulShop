...
namespace SoulShop.DAL
{
	...
	public partial class T_Base_Address
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "T_Base_Address"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from T_Base_Address");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(SoulShop.Model.T_Base_Address model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(SoulShop.Model.T_Base_Address model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_Base_Address set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_Base_Address ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public SoulShop.Model.T_Base_Address GetModel(int ID)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public SoulShop.Model.T_Base_Address DataRowToModel(DataRow row)
		{
			SoulShop.Model.T_Base_Address model=new SoulShop.Model.T_Base_Address();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_Base_Address T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_Base_Address";
